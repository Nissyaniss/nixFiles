  ...
  programs.starship = {
    ...
    settings = {
      ...
      custom.without_git_and_at_home = {
        when = "nu ${self}/config/starship/scripts/isntGitAndIsAtHome.nu";
        format = "[ ](fg:#6C6C6C bg:#444444)[ ~ ](bg:#444444 fg:#0997D5)[](fg:#444444)";
      };


      custom.without_git = {
        command = "nu ${self}/config/starship/scripts/getDirectoryRelativeToHome.nu";
        when = "nu ${self}/config/starship/scripts/isntGit.nu";
        format = "[ ](fg:#6C6C6C bg:#444444)[ ](bg:#444444 fg:#0997D5)[$output ](bg:#444444 fg:#0997D5)[](fg:#444444)";
      };

      custom.with_git = {
        command = "nu ${self}/config/starship/scripts/getDirectoryRelativeToHome.nu";
        when = "nu ${self}/config/starship/scripts/isGit.nu";
        format = "[ ](fg:#6C6C6C bg:#444444)[ ](bg:#444444 fg:#0997D5)[$output ](bg:#444444 fg:#0997D5)";
      };

      custom.root_without_git = {
        command = "nu ${self}/config/starship/scripts/getDirectoryRelativeToRoot.nu";
        when = "nu ${self}/config/starship/scripts/isntGitAndIsRoot.nu";
        format = "[ ](fg:#6C6C6C bg:#444444)[ /](bg:#444444 fg:#0997D5)[$output ](bg:#444444 fg:#0997D5)[](fg:#444444)";
      };

      custom.root_with_git = {
        command = "nu ${self}/config/starship/scripts/getDirectoryRelativeToRoot.nu";
        when = "nu ${self}/config/starship/scripts/isGitAndIsRoot.nu";
        format = "[ ](fg:#6C6C6C bg:#444444)[ /](bg:#444444 fg:#0997D5)[$output ](bg:#444444 fg:#0997D5)";
      };
    };
  };
